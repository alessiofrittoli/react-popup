# Contributing to React PopUp 💬

We’re excited that you’re interested in contributing to React PopUp! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/react-popup/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/react-popup).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/react-popup.git
```
...
Thank you for helping improve React PopUp! 🎉
